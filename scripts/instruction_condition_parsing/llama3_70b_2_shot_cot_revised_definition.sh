...
#SBATCH --job-name=llama3_70b_2_shot_cot            # Job name
...
python ~/Repos/cnlp_transformers/src/cnlpt/cnlp_seqgen.py \
       --model_path unsloth/llama-3-70b-Instruct-bnb-4bit \
       --prompt_file ~/CRICO_experiments_packet_PHI/2_shot_experiment_revised_definitions/system_prompt_multitag.txt \
       --examples_file ~/CRICO_experiments_packet_PHI/2_shot_experiment_revised_definitions/2_cot_examples.txt \
       --load_in_4bit \
       --max_new_tokens 2048 \
       --query_files ~/CRICO_experiments_packet_PHI/2_shot_experiment_revised_definitions/selected_examples.tsv \
